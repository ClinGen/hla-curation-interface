"""Provide views for bioRxiv publications."""
...
class RxivBioView(EntityView):
    """Create, view all, or view a bioRxiv publication."""

    @staticmethod
    @login_required
    def new(request: HttpRequest) -> HttpResponse:
        """Return the view that provides a form that creates a bioRxiv publication."""
        return render(
            request,
            "publications/biorxiv/new.html",
            {"tabs": new_biorxiv_publication_tabs},
        )
    ...
    def list(request: HttpRequest) -> HttpResponse:
        ...
        return render(
            request,
            "publications/biorxiv/list.html",
            {"tabs": search_biorxiv_publication_tabs},
        )
